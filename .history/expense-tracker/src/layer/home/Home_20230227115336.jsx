      ...
      <div className="main">
        <div className="home-content">
          ...
          <p className="home-content-subtitle">
            ...
            control of your finances. With just a few taps, you can track all of
            your expenses, including your bills, groceries, entertainment, and
            more.{" "}
          </p>
          <p className="home-content-subtitle">
          ...
          <NavLink to="expense-tracker" className="home-content-btn">
